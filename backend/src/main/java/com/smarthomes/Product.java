...
public class Product implements Serializable {
    ...
    public Product(int id, String retailer, String category, String nameP, double priceP, String description, String imageP, List<Accessory> accessories, int quantity) {
        this.id = id;
