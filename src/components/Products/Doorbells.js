...
const doorbellProducts = [
  ...
  },
  {
    ...
    price: "$13.99",
    description: "Smart Video Doorbell Camera Wireless, AI Human Detection and Instant Alerts, Night Vision, 2-Way Audio, Battery Powered, Cloud Storage, 2.4G WiFi",
      ...
      <header className="bg-[#550403] text-white p-4">
        <div className="container mx-auto flex justify-between items-center flex-wrap">
          ...
          <nav className="flex space-x-2 sm:space-x-4 items-center">
            ...
            <Link to="/products" className="text-sm sm:text-base">All Products</Link>
            <SignedIn>
